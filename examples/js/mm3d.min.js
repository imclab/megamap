...
mm3d.WgLoading=function(a){mm3d.Widget.call(this);var b=mm3d.Util.div().attr({className:"mm3dLoadingTitle"}).html("LOADING...");this.base=mm3d.Util.div().attr({className:"mm3dLoading"}).w(parseInt(window.innerWidth)).h(parseInt(window.innerHeight));this._content=mm3d.Util.div().attr({className:"mm3dLoadingContent"});b.css({top:0.5*(a[1]-parseInt(b.get().clientHeight))+"px"});this.barWidth=parseInt(0.8*window.innerWidth);this.bar=(new mm3d.Util.div).attr({className:"mm3dHr"}).w(0);this.base.add(b).add(this.bar).add(mm3d.Util.div().attr({className:"mm3dLoadingTitle"}).html("MEGAMAP").css({color:"#ff5b56",
fontSize:"3em",textShadow:"none"}))};mm3d.WgLoading.prototype=new mm3d.Widget;mm3d.WgLoading.prototype.content=function(a){this._content.html(a);return this};mm3d.WgLoading.prototype.status=function(a){this.bar.w(this.barWidth*a);return this};mm3d.WgLoading.prototype.constructor=mm3d.WgLoading;
mm3d.WgToolbox=function(){var a=(new mm3d.Util.span).html("help").attr({className:"mm3dMenuItem"});a.evt("click",function(){var a=(new mm3d.Util.div).attr({className:"mm3dHover"}).w(window.innerWidth).h(0.8*window.innerHeight).css({paddingLeft:parseInt(0.2*window.innerWidth)+"px"}).html("<img src='https://github.com/alpha360x/megamap/raw/master/res/help.png' width='"+parseInt(0.6*window.innerWidth)+"' height='"+parseInt(0.8*window.innerHeight)+"' ></img>"),b=(new mm3d.Util.div).attr({className:"mm3dLoadingTitle"}).html("CLOSE").css({position:"fixed",
zIndex:"401",cursor:"pointer",left:parseInt(0.6*window.innerWidth)+"px",top:parseInt(0.6*window.innerHeight)+"px"});b.evt("click",function(a,b){return function(){document.body.removeChild(a);document.body.removeChild(b)}}(a.get(),b.get()));document.body.appendChild(a.get());document.body.appendChild(b.get())});var b=(new mm3d.Util.span).html("export").attr({className:"mm3dMenuItem"}),d=(new mm3d.Util.div).attr({className:"mm3dMenuBox"});this.exp2jpeg=(new mm3d.Util.div).html("export2jpeg").attr({className:"mm3dBoxItem"});
this.exp2png=(new mm3d.Util.div).html("export2png").attr({className:"mm3dBoxItem"});this.base=(new mm3d.Util.div).attr({className:"mm3dToolbox"}).add(b.add(d.add(this.exp2jpeg).add(this.exp2png))).add(a)};mm3d.WgToolbox.prototype=new mm3d.Widget;mm3d.WgToolbox.prototype.constructor=mm3d.WgToolbox;mm3d.WgTitle=function(a){this.base=(new mm3d.Util.div).html(void 0===a?"":a).attr({className:"mm3dTitle"})};mm3d.WgTitle.prototype=new mm3d.Widget;
mm3d.WgTitle.prototype.content=function(a){this.base.html(a);return this};mm3d.WgTitle.prototype.constructor=mm3d.WgTitle;
...
mm3d.WgScalerule.prototype.constructor=mm3d.WgScalerule;mm3d.WgLegend=function(a){this.base=(new mm3d.Util.div).attr({className:"mm3dLegendContainer"});this._ctx=(new mm3d.Util.div).attr({className:"mm3dLegendCtx"});this._node=(new mm3d.Util.div).attr({className:"mm3dLegend"}).h(a[1]/3);this.base.add(this._node.add(this._ctx))};mm3d.WgLegend.prototype=new mm3d.Widget;mm3d.WgLegend.prototype.repaint=function(a,b){for(var d=this._ctx.get();d.firstChild;)d.removeChild(d.firstChild);for(var c in a.model)this._ctx.add((new mm3d.Util.div).attr({className:"mm3dLegendItem"}).add((new mm3d.Util.span).attr({className:"mm3dLegendColor"}).css({backgroundColor:b.getColor(c).getContextStyle()})).add((new mm3d.Util.span).attr({className:"mm3dLegendName"}).html(c)).add((new mm3d.Util.span).attr({className:"mm3dLegendValue"}).html(a.model[c].data)))};
mm3d.WgLegend.prototype.constructor=mm3d.WgLegend;
mm3d.WgCamCtrl=function(){this.base=(new mm3d.Util.div).attr({className:"mm3dCamContainer"});var a=Math.sqrt(2),a=[{pos:[2*a-1,a-1],sign:mm3d.PAN_TOP},{pos:[a-1,2*a-1],sign:mm3d.PAN_LEFT},{pos:[3*a-1,2*a-1],sign:mm3d.PAN_RIGHT},{pos:[2*a-1,3*a-1],sign:mm3d.PAN_DOWN}];this.bts={};for(var b=["up","left","right","down"],d=(new mm3d.Util.div).attr({className:"mm3dCamButtonContent"}),c=0;c<a.length;c++)this.bts[a[c].sign]=mm3d.Util.div().attr({className:"mm3dCamButton"}).css({left:18*a[c].pos[0]+"px",
top:18*a[c].pos[1]+"px"}).evt("mouseover",function(a,b){return function(){b.html("camera : move "+a);return!1}}(b[c],d)).evt("mouseout",function(a,b){return function(){b.html("");return!1}}(b[c],d)),this.base.add(this.bts[a[c].sign]);this.base.add(d)};mm3d.WgCamCtrl.prototype=new mm3d.Widget;mm3d.WgCamCtrl.prototype.constructor=mm3d.WgCamCtrl;
...
_mkHoverImage:function(b){return(new mm3d.Util.div).attr({className:"mm3dHover"}).w(0.6*window.innerWidth).h(0.8*window.innerHeight).css({marginLeft:parseInt(0.2*window.innerWidth)+"px"}).html("<img src='"+b+"' width='"+parseInt(0.6*window.innerWidth)+"' height='"+parseInt(0.8*window.innerHeight)+"' ></img>")},_webglFallback:function(){document.body.appendChild(this._mkHoverImage("https://github.com/alpha360x/megamap/raw/master/res/fb_webGL.png").get())},init:function(){if(window.WebGLRenderingContext){for(var b=
0;b<this._widgets.length;b++)this._vp.appendChild(this._widgets[b].getDOM());this._widgets[mm3d.WIDGET_SCALERULE].max(this._dataModel.max).min(this._dataModel.min).repaint(this._colorModel.minC.getContextStyle(),this._colorModel.maxC.getContextStyle());this._vp.appendChild(this._loading.getDOM());this._widgets[mm3d.WIDGET_LEGEND].repaint(this._dataModel,this._colorModel);window.addEventListener("keydown",function(a){return function(b){switch(b.which){case 81:a._transform.type=mm3d.ZOOM_IN;a._transform.delta=
0.03;break;case 69:a._transform.type=mm3d.ZOOM_OUT;a._transform.delta=-0.03;break;case 87:a._transform.type=mm3d.PAN_TOP;a._transform.delta=0.1;break;case 65:a._transform.type=mm3d.PAN_LEFT;a._transform.delta=0.1;break;case 68:a._transform.type=mm3d.PAN_RIGHT;a._transform.delta=0.1;break;case 83:a._transform.type=mm3d.PAN_DOWN,a._transform.delta=0.1}}}(this),!1);window.addEventListener("keyup",this._noTransform(this),!1);this._vp.addEventListener("mousemove",this._rotationHandler(this),!1);this._map3D=
new mm3d.Map3D(this._dataModel,this._colorModel,{size:this._size,urlPrefix:this._urlPrefix,maxBarHeight:this._maxBarHeight});this._map3D.addEventListener("loadStatus",function(a){return function(b){a._loading.status(b.count/a._dataModel.length)}}(this));this._map3D.addEventListener("load",function(a){return function(){a._mapDOM=a._map3D.getDOM();a._mapDOM.className="mm3dMap";a._vp.removeChild(a._loading.getDOM());a._vp.appendChild(a._mapDOM);a._map3D.repaint(!a._ani.isRun,!0);a._mainloop(a)();a._mapDOM.addEventListener("mouseup",
a._noTransform(a),!1);a._mapDOM.addEventListener("mousedown",function(a){return function(){a._transform.type=mm3d.ROTATE}}(a),!1);a._initCamCtrl();a._initToolbox();a._dispatchEvent("load")}}(this));this._map3D.loadMeshes()}else this._webglFallback()},constructor:mm3d.AbstractMap};
